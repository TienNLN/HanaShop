            ...
            <form action="DispatchServlet">
                <main role="main" class="form-group align-items-center">
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="text" 
                               <c:if test="${not empty requestScope.ITEM_NAME_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_NAME_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtName" placeholder="Enter Item Name">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_NAME_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="text" 
                               <c:if test="${not empty requestScope.ITEM_IMG_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_IMG_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtImage" placeholder="Enter Image Link">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_IMG_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="text" 
                               <c:if test="${not empty requestScope.ITEM_DESCRIPTION_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_DESCRIPTION_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtDescription" placeholder="Enter Description">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_DESCRIPTION_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="number" 
                               <c:if test="${not empty requestScope.ITEM_PRICE_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_PRICE_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtPrice" placeholder="Enter Price">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_PRICE_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="text" 
                               <c:if test="${not empty requestScope.ITEM_CATEGORY_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_CATEGORY_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtCategory" placeholder="Enter Category">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_CATEGORY_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="form-group col-md-3" style="margin-left: 20px">
                        ...
                        <input type="number" 
                               <c:if test="${not empty requestScope.ITEM_QUANTITY_EMPTY_ERR}">
                                   class="form-control is-invalid"
                               </c:if>
                               <c:if test="${empty requestScope.ITEM_QUANTITY_EMPTY_ERR}">
                                   class="form-control"
                               </c:if>
                               name="txtQuantity" placeholder="Enter Quantity">
                        <div class="invalid-feedback">
                            ${requestScope.ITEM_QUANTITY_EMPTY_ERR}
                        </div>
                    </div>
                    <br/>
